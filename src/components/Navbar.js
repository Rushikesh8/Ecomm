...
const Navbar = () => {
  // const count = <span class="snipcart-items-count"></span>
  // console.log(count)
  // const [count,setCount] = React.useState()
  // useEffect(() => {
  //   setCount(<span class="snipcart-items-count"></span>)
      ...
      <nav class="bg-white shadow w-full border-b-2 border-teal-500">
        <div class="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
            ...
            <div class="items-center md:flex">
                ...
                <div class="flex justify-between items-center flex-col md:flex-row gap-x-4">
                    <a class="relative text-gray-700  hover:text-teal-600 snipcart-checkout" href="#">
                    ...
                    <div className="text-gray-700  hover:text-teal-600 cursor-pointer snipcart-customer-signin"> 
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg></div>
                    {/* <a class="snipcart-customer-signin" href="">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                   <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                 </svg>
                    </a> */}
