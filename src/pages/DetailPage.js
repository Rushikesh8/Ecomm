...
const DetailPage = ({data,pageContext}) => {
   ...
   var product = data.markdownRemark.frontmatter.product.filter(ele => ele.slug == pageContext.slug)[0]
    ...
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="detail-img" src={product.url}/>
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{product.title}</h1>
        <h2 class="text-sm title-font text-gray-500 tracking-widest my-3">{product.author}</h2>
        <div class="flex mb-4">
        ...
        <div class="flex">
          ...
          data-item-url={"/"}
          data-item-price={product.price}>Buy</button>
